...
import nosexunitlite.const
import nosexunitlite.plugin
...
class TestCase(unittest.TestCase):
    '''Super class of test for NoseXUnitLite basic tests'''

    def setUp(self):
        '''Set up for NoseXUnitLite super class of test'''
    ...
    def tearDown(self):
        '''Tear down for NoseXUnitLite super class of test'''
...
class PluginTestCase(nose.plugins.PluginTester, TestCase):
    '''Super class of test for NoseXUnitLite plug in tests'''

    activate = '--with-nosexunitlite'
    ...
    def setUp(self):
        ...
        TestCase.setUp(self)
        # Create the plug in
        self.plugins = [nose.plugins.deprecated.Deprecated(), nose.plugins.skip.Skip(), nosexunitlite.plugin.NoseXUnitLite(), ]
    ...
    def setUpExtra(self, includes=[], excludes=nosexunitlite.const.AUDIT_COVER_EXCLUDE, tp=False):
